...
class ImageEnhancer:
    ...
    def _get_output_path(
        ...
        if output_dir:
            ...
            return (
                output_dir_path / f"{image_path.stem}_enhanced.{output_format.lower()}"
            )
    ...
    def _process_single_image(
        ...
        try:
            ...
            image, is_bw = self.preprocess_image(
                image_path, output_format=output_format
            )
